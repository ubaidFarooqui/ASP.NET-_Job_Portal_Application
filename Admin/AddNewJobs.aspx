...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <p>
        <asp:Label ID="Label7" runat="server" Font-Size="Medium" ForeColor="#FF6600" Text="Add New Job"></asp:Label>
</p>
    <table style="width: 100%">
        <tr>
            <td style="height: 17px; width: 315px;" align="right">
                &nbsp;</td>
        ...
        <tr>
            <td style="height: 17px; width: 315px;" align="right">
                <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Small" Text="*Job Title"></asp:Label>
            </td>
            <td style="height: 17px">
                <asp:TextBox ID="txt_jobtitle" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please enter the Job title" ControlToValidate="txt_jobtitle" ForeColor="Red">Please enter the job Title</asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            ...
            <td valign="top">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Please enter the job description" ControlToValidate="txt_description" ForeColor="Red">Please enter the Job description</asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
